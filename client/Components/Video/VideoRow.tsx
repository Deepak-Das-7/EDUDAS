    ...
    return (
        <View style={styles.row}>
            <View style={styles.cell}>
                <Text style={styles.cellText}>{test.videoName}</Text>
            </View>
            <View style={styles.cell2}>
                <MaterialIcons name="edit" size={24} color={theme.textColors.primaryText} onPress={() => router.push(`/Admin/Video/${test._id}`)} />
